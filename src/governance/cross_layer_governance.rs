...
use crate::governance::validator_rewards::ValidatorRewards; // Correct import for ValidatorRewards
...
pub struct CrossLayerGovernance {
    ...
    pub rewards: Arc<ValidatorRewards>, // Correct struct for rewards management
...
impl CrossLayerGovernance {
    pub fn new(
        ...
        rewards: Arc<ValidatorRewards>, // Fixed parameter name
    ...
    fn calculate_voting_power(&self) -> Result<u64, String> {
        ...
        let total_power: u64 = nodes
            ...
            .map(|(_, node)| policies.adjust_voting_power(node))
            .sum();
    ...
    fn apply_proposal(&self, proposal: GovernanceProposal) -> Result<(), String> {
        match proposal.param.as_str() {
            ...
            "reward_rate" => {
                self.rewards.adjust_reward_rate(proposal.value)?;
